	...
	<%@include file="navbar.jsp" %>
		<div class="container">
	    	<div class="col-md-6 col-lg-5 mx-auto" style="max-width: 500px; margin-top: 40px;">
	        	<h1 class="text-center">Search Donor if Already Donated</h1>
	        	<form action="CheckDonor" method="POST">
		            ...
		            <div class="form-group">
	                	<label for="unitswant">Units Want To Donate Again:</label>
